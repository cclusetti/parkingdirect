...
public class CheapestActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        cheapestMapButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				Intent myIntent = new Intent(CheapestActivity.this, GoogleMap.class);
				Bundle b = new Bundle();
        ...
        nextCheapestButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
		        ...
		        SimpleAdapter mSchedule = new SimpleAdapter(CheapestActivity.this, myList, R.layout.dirs_list_item, new String[]{"Dir", "Dist"},new int[]{R.id.dir_Cell, R.id.dist_Cell}); 
